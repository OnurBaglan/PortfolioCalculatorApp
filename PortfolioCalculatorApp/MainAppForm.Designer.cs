namespace PortfolioCalculatorApp
{
	partial class MainAppForm
	{
		...
		private void InitializeComponent()
		{
			...
			Button_APIKey2ValidateAndSave = new Button();
			Button_APIKey1ValidateAndSave = new Button();
			...
			ListBox_Portfolios.SelectedIndexChanged += listBox1_SelectedIndexChanged;
			// 
			...
			Button_AddNewPortfolio.Click += button1_Click;
			// 
			...
			FixedLabel_PortfolioList.Click += label1_Click;
			// 
			...
			FixedLabel_Ratio.Click += label3_Click;
			// 
			...
			TabPage2.Controls.Add(Button_APIKey2ValidateAndSave);
			TabPage2.Controls.Add(Button_APIKey1ValidateAndSave);
			...
			Label_APIKey2Status.Location = new Point(658, 94);
			...
			Label_APIKey1Status.Location = new Point(658, 51);
			...
			// 
			// Button_APIKey2ValidateAndSave
			// 
			Button_APIKey2ValidateAndSave.Location = new Point(495, 86);
			Button_APIKey2ValidateAndSave.Name = "Button_APIKey2ValidateAndSave";
			Button_APIKey2ValidateAndSave.Size = new Size(132, 23);
			Button_APIKey2ValidateAndSave.TabIndex = 5;
			Button_APIKey2ValidateAndSave.Text = "Validate and save";
			Button_APIKey2ValidateAndSave.UseVisualStyleBackColor = true;
			// 
			// Button_APIKey1ValidateAndSave
			// 
			Button_APIKey1ValidateAndSave.Location = new Point(495, 47);
			Button_APIKey1ValidateAndSave.Name = "Button_APIKey1ValidateAndSave";
			Button_APIKey1ValidateAndSave.Size = new Size(132, 23);
			Button_APIKey1ValidateAndSave.TabIndex = 4;
			Button_APIKey1ValidateAndSave.Text = "Validate and save";
			Button_APIKey1ValidateAndSave.UseVisualStyleBackColor = true;
			// 
			// FixedLabel_APIKey2
			// 
			...
			FixedLabel_APIKey1.Click += label9_Click;
			// 
			// TextBox_APIKey2
			// 
			...
			TextBox_APIKey1.TextChanged += textBox1_TextChanged;
			// 
			// MainAppForm
			// 
		...
		private Button Button_APIKey2ValidateAndSave;
		private Button Button_APIKey1ValidateAndSave;
